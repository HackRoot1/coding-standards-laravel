...
<div class="card-body">
    <form method="POST" action="{{ route('pay.order') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="amount" class="form-control" value="1000" min="1" required>
        </div>
...
## Step 8: (Optional) Webhooks

1. Enable webhooks in Razorpay Dashboard.
2. Use the provided `PaymentWebhookController.php` (from the guide above) to verify and update payments.
